...
这里使用中位数而不是平均值，是因为文章中常混入少量极难词、专有名词或领域术语。平均值易受这些极端词影响，可能高估文章整体语言要求；中位数关注难度序列中间位置的值，能更稳定地代表文章主体词汇水平。累计百分位的含义可以类比考试排名：如果文章词汇难度的中位数超过了词库中 3,000 个词，那么系统就认为理解这篇文章大约需要 3,000 词左右的储备。
